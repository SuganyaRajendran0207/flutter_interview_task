...
import 'package:flutter_interview_task/presentation/styles/constants.dart';
...
ThemeData _buildBaseTheme({ThemeMode themeMode = ThemeMode.system}) {
  ...
  return baseTheme.copyWith(
    ...
    scaffoldBackgroundColor: AppColors.scaffoldColor.of(themeMode),
    ...
    appBarTheme: baseTheme.appBarTheme.copyWith(
      systemOverlayStyle: SystemUiOverlayStyle(
        statusBarBrightness: ThemeData.estimateBrightnessForColor(
          AppColors.statusBarColor.of(themeMode),
        ),
        statusBarIconBrightness: ThemeData.estimateBrightnessForColor(
          AppColors.statusBarColor.of(themeMode),
        ),
        statusBarColor: AppColors.statusBarColor.of(themeMode),
        systemNavigationBarColor: AppColors.navigationBarColor.of(themeMode),
      ),
      elevation: 0.5,
      iconTheme: baseTheme.iconTheme
          .copyWith(color: AppColors.appBarIconColor.of(themeMode)),
      color: AppColors.appBarColor.of(themeMode),
      titleTextStyle: TextStyles.appBarTitleStyle(brightness: brightness),
